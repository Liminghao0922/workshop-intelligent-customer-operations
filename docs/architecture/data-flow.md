...
2. Backend sends message to Azure AI Foundry Agent.
3. Agent classifies intent and determines next step.
4. Agent uses Fabric IQ for knowledge-grounded response when appropriate.
...
|---|---|---|
| Knowledge documents | FAQ, policy, troubleshooting guide | Fabric IQ / Agent |
